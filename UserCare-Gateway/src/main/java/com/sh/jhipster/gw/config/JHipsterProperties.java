...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipstergw@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipstergw API";

        private String description = "jhipstergw API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipstergw";

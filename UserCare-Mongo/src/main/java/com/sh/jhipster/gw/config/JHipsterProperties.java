...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipsterMongoDB@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipsterMongoDB API";

        private String description = "jhipsterMongoDB API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipsterMongoDB";
